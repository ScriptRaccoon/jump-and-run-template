...
new Rectangle({ pos: [990, 0], size: [10, 10], color: "red" });
new Rectangle({ pos: [0, 0], size: [10, 10], color: "red" });
new Rectangle({ pos: [0, 990], size: [10, 10], color: "red" });
new Rectangle({ pos: [990, 990], size: [10, 10], color: "red" });
